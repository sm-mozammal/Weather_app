class GitupModel {
  ...
  GitupModel.fromJson(dynamic json) {
  ...
  List<Items>? items;
GitupModel copyWith({  num? totalCount,
  bool? incompleteResults,
  List<Items>? items,
}) => GitupModel(  totalCount: totalCount ?? this.totalCount,
